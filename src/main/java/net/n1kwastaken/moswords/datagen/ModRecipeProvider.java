...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.VAMPIRE_SWORD)
                .pattern(" A ")
                .pattern("WBW")
                .pattern(" S ")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.RUBY_SWORD)
                .pattern("R")
                .pattern("R")
                .pattern("S")
                .input('S', Items.STICK)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.DEVILS_EYE_SWORD)
                .pattern("R")
                .pattern("E")
                .pattern("S")
                .input('S', Items.STICK)
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.SLIME_SWORD)
                .pattern("B")
                .pattern("B")
                .pattern("S")
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.MISC, ModItems.WOODEN_DAGGER)
                .pattern("  F")
                .pattern(" T ")
                .pattern("S  ")
                .input('S', Items.STICK)
...
//        BiggerShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.BIGGER_CRAFTING_TABLE)
//                .pattern("BPPB")
//                .pattern("ECCS")
//                .pattern("ACCR")
//                .pattern("BPPB")
...
//                .offerTo(exporter);
        ...
        ShapedRecipeJsonBuilder.create(RecipeCategory.DECORATIONS, ModBlocks.BIGGER_CRAFTING_TABLE)
                .pattern("EBS")
                .pattern("PCP")
                .pattern("ABR")
